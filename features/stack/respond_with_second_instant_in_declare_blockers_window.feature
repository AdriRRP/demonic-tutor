# status: implemented
# rules: 117, 508, 509, 601, 608
# slices: respond-with-second-instant-in-declare-blockers-window.md

Feature: Respond with a second instant in the declare-blockers window

  Scenario: Bob casts a second instant before passing priority in DeclareBlockers

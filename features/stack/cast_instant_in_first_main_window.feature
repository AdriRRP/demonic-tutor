...
# slices: cast-instant-in-first-main-window.md

Feature: Cast an instant during the first main priority window

  Scenario: Alice casts and resolves an instant during FirstMain

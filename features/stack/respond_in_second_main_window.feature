...
# slices: respond-in-second-main-window.md

Feature: Respond with an instant during the second main priority window
  Scenario: Bob casts and resolves an instant after Alice passes priority in SecondMain

...
# slices: respond-with-second-instant-in-second-main-window.md

Feature: Respond with a second instant during the second main priority window

  Scenario: Bob casts a second instant before passing priority in SecondMain

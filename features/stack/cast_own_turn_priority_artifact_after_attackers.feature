...
# slices: cast-own-turn-priority-artifact-after-attackers.md

Feature: Cast an own-turn-priority artifact after attackers
  Scenario: Alice casts and resolves an own-turn-priority artifact after attackers are declared

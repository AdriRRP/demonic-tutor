...
# slices: respond-with-second-instant-in-end-step-window.md

Feature: Respond with a second instant during the end-step priority window

  Scenario: Bob casts a second instant before passing priority in EndStep

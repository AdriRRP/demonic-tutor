...
# slices: respond-in-upkeep-window.md

Feature: Respond with an instant during the upkeep priority window
  Scenario: Bob casts and resolves an instant after Alice passes priority in Upkeep

...
# slices: cast-own-turn-priority-artifact-after-blockers.md

Feature: Cast an own-turn-priority artifact after blockers
  Scenario: Alice casts and resolves an own-turn-priority artifact after blockers are declared

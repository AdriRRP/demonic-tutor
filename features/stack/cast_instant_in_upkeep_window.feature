...
# slices: cast-instant-in-upkeep-window.md

Feature: Cast an instant during the upkeep priority window

  Scenario: Alice casts and resolves an instant during Upkeep

...
# slices: cast-second-instant-after-attackers.md

Feature: Cast a second instant after attackers are declared

  Scenario: Alice casts a second instant before passing priority after attackers

...
# slices: respond-in-draw-window.md

Feature: Respond with an instant during the draw priority window
  Scenario: Bob casts and resolves an instant after Alice passes priority in Draw

...
- a hidden opponent hand fan rendered with classic-inspired generated card backs instead of text counters
...
- generated card piles for library, graveyard, and exile using classic-inspired CSS-built backs and compact face-up zone tops

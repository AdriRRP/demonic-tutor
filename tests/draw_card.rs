    ...
    let cmd = DealOpeningHandsCommand::new(vec![
        player_deck_contents(
            ...
            vec![
                ...
                (String::from("card-8"), CardType::Creature),
                (String::from("card-9"), CardType::Creature),
                (String::from("card-10"), CardType::Creature),
                (String::from("card-11"), CardType::Creature),
                (String::from("card-12"), CardType::Creature),
            ],
        ),
        player_deck_contents(
            "player-2",

...
impl GameplayWorld {
    ...
    pub fn setup_priority_after_attackers_declared_with_own_turn_enchantment(&mut self) {
        let attacker_id = prepare_priority_after_attackers_declared(
            self,
            "bdd-combat-priority-attackers-own-turn-enchantment",
            vec![
                attacker_card(),
    ...
    pub fn setup_priority_after_attackers_declared_with_nonlethal_controlled_attacking_spell(
        &mut self,
    ) {
        let attacker_id = prepare_priority_after_attackers_declared(
            self,
            "bdd-combat-priority-attackers-controlled-attacker-nonlethal",
            vec![
                demonictutor::LibraryCard::creature(

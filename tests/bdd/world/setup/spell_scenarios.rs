...
impl GameplayWorld {
    ...
    pub fn setup_cast_mixed_green_instant(&mut self) {
        self.reset_game_with_libraries(
            "bdd-cast-mixed-green-instant",
            support::filled_library(
                vec![
                    support::mixed_green_instant_card("bdd-ancient-stirring", 1),
                    support::forest_card("bdd-forest"),
                    support::mountain_card("bdd-mountain"),
                ],
                10,
        ...
        let forest_id = self.hand_card_by_definition("Alice", "bdd-forest");
        service
            .play_land(
                self.game_mut(),
                PlayLandCommand::new(Self::player_id("Alice"), forest_id),
            )
            .expect("setup forest play should succeed");
        ...
        self.tracked_card_id = Some(self.hand_card_by_definition("Alice", "bdd-ancient-stirring"));
        self.tracked_blocker_id = Some(
            self.player("Alice")
                .battlefield_card_by_definition(&demonictutor::CardDefinitionId::new("bdd-forest"))
                .expect("forest should be on battlefield")
                .id()
                .clone(),
        );
        self.tracked_second_response_card_id =
            Some(self.hand_card_by_definition("Alice", "bdd-mountain"));
        self.reset_observations();
    }
    ...
    pub fn setup_cast_mixed_green_instant_without_green(&mut self) {
        self.reset_game_with_libraries(
            "bdd-cast-mixed-green-instant-no-green",
            support::filled_library(
                vec![
                    support::mixed_green_instant_card("bdd-ancient-stirring", 1),
                    support::mountain_card("bdd-mountain"),
                    support::plains_card("bdd-plains"),
                ],
                10,
            ),
            support::filled_library(Vec::new(), 10),
        ...
        let mountain_id = self.hand_card_by_definition("Alice", "bdd-mountain");
        service
            .play_land(
                self.game_mut(),
                PlayLandCommand::new(Self::player_id("Alice"), mountain_id),
            )
            .expect("setup mountain play should succeed");
        ...
        self.tracked_second_response_card_id =
            Some(self.hand_card_by_definition("Alice", "bdd-plains"));
        self.reset_observations();
    }
    ...
    pub fn setup_targeted_opponents_creature_spell(&mut self) {
        self.reset_game_with_libraries(
            "bdd-targeted-opponents-creature-spell",
            support::filled_library(
                vec![
                    support::land_card("bdd-mountain"),
    ...
    pub fn setup_exile_target_creature_spell(&mut self) {
        self.reset_game_with_libraries(
            "bdd-exile-target-creature-spell",
            support::filled_library(
                vec![
                    support::land_card("bdd-mountain"),
                    support::targeted_exile_creature_instant_card("bdd-banish-lite", 0),
                ],
                10,
            ),
            support::filled_library(vec![support::creature_card("bdd-bob-bear", 0, 2, 2)], 10),
        ...
        service
            ...
            .expect("setup exile target creature spell cast should succeed");
        self.pass_priority("Bob");
        self.pass_priority("Alice");
        support::advance_to_player_first_main_satisfying_cleanup(
            &service,
        ...
        self.tracked_card_id = Some(self.hand_card_by_definition("Alice", "bdd-banish-lite"));
        self.tracked_blocker_id = Some(creature_id);
        self.reset_observations();
    }

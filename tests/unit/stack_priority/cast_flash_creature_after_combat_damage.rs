...
//! Unit coverage for unit stack priority cast flash creature after combat damage.
...
#[test]
fn active_player_can_cast_a_flash_creature_after_combat_damage_resolves() {
    let (service, mut game) = setup_two_player_game(
        "game-flash-after-combat-damage",
        filled_library(
            vec![
    ...
    let attacker_id = CardInstanceId::new("game-flash-after-combat-damage-player-1-0");
    service
        .cast_spell(
            &mut game,
    ...
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-1"),
                CardInstanceId::new("game-flash-after-combat-damage-player-1-1"),
            ),
        )
        .unwrap();
    ...
    assert_eq!(
        ...
        "game-flash-after-combat-damage-player-1-1"
    );
}

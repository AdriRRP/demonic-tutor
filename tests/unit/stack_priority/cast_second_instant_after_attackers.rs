...
//! Unit coverage for unit stack priority cast second instant after attackers.
...
#[test]
fn active_player_can_cast_a_second_instant_before_passing_after_attackers() {
    let (service, mut game) = setup_two_player_game(
        "game-second-after-attackers",
        filled_library(
            vec![
                LibraryCard::creature(CardDefinitionId::new("attacker"), 0, 2, 2),
                instant_card("after-attackers-a", 0),
                instant_card("after-attackers-b", 0),
            ],
            10,
        ),
    ...
    let attacker_id = CardInstanceId::new("game-second-after-attackers-player-1-0");
    service
        .cast_spell(
            &mut game,
    ...
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-1"),
                CardInstanceId::new("game-second-after-attackers-player-1-1"),
            ),
        )
        .unwrap();
    service

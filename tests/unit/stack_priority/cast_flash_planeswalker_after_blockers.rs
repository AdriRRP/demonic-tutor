...
//! Unit coverage for unit stack priority cast flash planeswalker after blockers.
...
#[test]
fn active_player_can_cast_a_flash_planeswalker_after_blockers_are_declared() {
    let (service, mut game) = setup_two_player_game(
        "game-flash-planeswalker-after-blockers",
        filled_library(
            vec![
    ...
    let attacker_id = CardInstanceId::new("game-flash-planeswalker-after-blockers-player-1-0");
    service
        .cast_spell(
            &mut game,
    ...
    let blocker_id = CardInstanceId::new("game-flash-planeswalker-after-blockers-player-2-0");
    service
        .cast_spell(
            &mut game,
    ...
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-1"),
                CardInstanceId::new("game-flash-planeswalker-after-blockers-player-1-1"),
            ),
        )
        .unwrap();
    ...
    assert_eq!(
        ...
        "game-flash-planeswalker-after-blockers-player-1-1"
    );
}

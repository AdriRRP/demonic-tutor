...
//! Unit coverage for unit stack priority cast flash creature after attackers.
...
#[test]
fn active_player_can_cast_a_flash_creature_after_attackers_are_declared() {
    let (service, mut game) = setup_two_player_game(
        "game-flash-after-attackers",
        filled_library(
            vec![
    ...
    let attacker_id = CardInstanceId::new("game-flash-after-attackers-player-1-0");
    service
        .cast_spell(
            &mut game,
    ...
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-1"),
                CardInstanceId::new("game-flash-after-attackers-player-1-1"),
            ),
        )
        .unwrap();
    ...
    assert_eq!(
        ...
        "game-flash-after-attackers-player-1-1"
    );
}

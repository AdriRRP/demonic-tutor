...
//! Unit coverage for unit stack priority respond with second instant in upkeep window.
...
#[test]
fn responding_player_can_cast_a_second_instant_before_passing_in_upkeep() {
    let (service, mut game) = setup_two_player_game(
        "game-respond-second-upkeep",
        filled_library(Vec::new(), 10),
        filled_library(
            vec![
                instant_card("upkeep-response-a", 0),
                instant_card("upkeep-response-b", 0),
            ],
            10,
        ),
    );
    ...
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-2"),
                CardInstanceId::new("game-respond-second-upkeep-player-2-0"),
            ),
        )
        .unwrap();
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-2"),
                CardInstanceId::new("game-respond-second-upkeep-player-2-1"),
            ),
        )
        .unwrap();

...
fn active_player_can_cast_a_second_instant_before_passing_in_end_step() {
    let (service, mut game) = setup_two_player_game(
        "game-second-end-step-instant",
        filled_library(
            vec![instant_card("end-step-a", 0), instant_card("end-step-b", 0)],
            10,
        ),
    ...
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-1"),
                CardInstanceId::new("game-second-end-step-instant-player-1-0"),
            ),
        )
        .unwrap();
    service
        .cast_spell(
            ...
            CastSpellCommand::new(
                PlayerId::new("player-1"),
                CardInstanceId::new("game-second-end-step-instant-player-1-1"),
            ),
        )
        .unwrap();

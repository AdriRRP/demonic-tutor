...
pub fn untap_target_creature_instant_card(name: &str, mana_cost: u32) -> LibraryCard {
    LibraryCard::new(CardDefinitionId::new(name), CardType::Instant, mana_cost)
...
pub fn sacrifice_life_gain_creature_card(
    name: &str,
    mana_cost: u32,
    power: u32,
    toughness: u32,
    ...
    creature_card(name, mana_cost, power, toughness).with_activated_ability(
        ActivatedAbilityProfile::tap_sacrifice_source_to_gain_life_to_controller(amount),
    )
}

...
- the current targeted-spell subset now also supports explicit combat-relative target restrictions such as `attacking creature`, `blocking creature`, `blocking creature you control`, and `attacking creature an opponent controls`

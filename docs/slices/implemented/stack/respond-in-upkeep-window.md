...
After the active player passes an empty `Upkeep` priority window, the non-active
player may cast and resolve an instant while holding priority.

## Supported Behavior

- `Upkeep` opens priority for the active player
...
- non-instant responses in upkeep
- triggered abilities and triggered upkeep stack entries

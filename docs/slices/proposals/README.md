...
8. `abilities-v1/activated-mana-ability-foundation.md`
9. `abilities-v1/activated-ability-uses-priority-windows.md`
10. `abilities-v1/mana-abilities-remain-stack-free.md`

## Wave 5 — Combat And Stability Closure

Directory: `combat-v1/`

11. `combat-v1/haste-creatures-can-attack-immediately.md`
12. `combat-v1/vigilance-creatures-do-not-tap-to-attack.md`
13. `combat-v1/trample-assigns-excess-damage-to-player.md`
14. `combat-v1/first-strike-changes-combat-damage-order.md`
15. `combat-v1/expand-state-based-actions-for-new-effects.md`
16. `combat-v1/stable-capability-matrix-sync.md`

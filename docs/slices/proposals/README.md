...
1. `engine-audit-v7/make-player-zone-transitions-transactional.md`
1. `engine-audit-v7/introduce-aggregate-level-card-location-index.md`
...
These proposals focus on the next excellence pass: indivisible commits, true internal identity, slimmer stack carriers, aggregate-level ownership lookup, and a stronger path away from public string ids in the core.

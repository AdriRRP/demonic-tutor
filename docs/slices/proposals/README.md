...
These proposals focus on the next excellence pass: leaner resolution carriers, transactional zone movement, stronger ordered-zone removal, and a stronger path away from public string ids in the core.

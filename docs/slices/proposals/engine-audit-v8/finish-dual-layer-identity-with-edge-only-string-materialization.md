# Proposal Slice — Finish Dual-Layer Identity With Edge-Only String Materialization

## Summary

Complete the dual-layer identity model so public string-backed ids are created only at true boundaries while the runtime core operates on compact internal ids.
...
- internal numeric or handle-based ids are canonical inside the runtime core

...
- broaden the value-engine side of the card pool without stepping into dishonest ownership or replacement semantics
...
- it makes slower decks and graveyard decks possible inside the same honest subset
